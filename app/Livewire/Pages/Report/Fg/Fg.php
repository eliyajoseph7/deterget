...
class Fg extends Component
{
    ...
    public function fetchReport() {
        $data = ProductReport::search($this->search)->select('date', DB::raw('SUM(received) as received'), DB::raw('SUM(dispatched) as dispatched'))
    ...
    public function render()
    {
        ...
        return view('livewire.pages.report.fg.fg');
    }
}
