    ...
    <thead class="text-xs text-gray-700 dark:text-gray-100 bg-gray-100 dark:bg-gray-800">
        <tr>
            <th colspan="7" rowspan="2"
                style="text-transform: uppercase; text-align: center; font-size: 16; font-weight: bold;">DISPATCHED RAW
                MATERIALS</th>
        </tr>
    </thead>
    <tbody class="">
        ...
        <tr>
            ...
            <th style="font-weight: 500;">Material</th>
            <th style="font-weight: 500;">Measure</th>
            <th style="font-weight: 500;">Quantity</th>
            <th style="font-weight: 500;">Purpose</th>
            <th style="font-weight: 500;">Dispatched By</th>
        </tr>
        @forelse ($data as $dt)
            <tr class="">
                <th scope="row"
