    ...
    <div class="h-full px-3 pb-4 overflow-y-auto bg-inherit dark:bg-gray-800">
        ...
        @if (Helper::has_role('super-user'))
            <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                ...
                <li>
                    <button type="button"
                        class="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group dark:text-white dark:hover:bg-gray-700 {{ in_array(Route::currentRouteName(), ['rm_report', 'fg_report', 'warehouse_report', 'sale_report', 'rm_detailed_report']) ? 'bg-blue-500 text-white font-bold hover:bg-blue-600' : '' }}"
                    ...
                    <ul id="dropdown-example"
                        class="{{ in_array(Route::currentRouteName(), ['rm_report', 'fg_report', 'warehouse_report', 'sale_report', 'rm_detailed_report']) ? '' : 'hidden' }} py-2 space-y-2">
                        <li>
                            <a href="{{ route('rm_report') }}"
                                class="flex font-normal items-center w-full p-2 transition duration-75 rounded-lg pl-11 group dark:text-white dark:hover:bg-gray-700 {{ (Route::is('rm_report') || Route::is('rm_detailed_report')) ? 'bg-gray-100 text-blue-700 font-bold hover:bg-blue-500' : 'font-normal text-gray-900 hover:bg-gray-100' }}">Raw
                                Materials</a>
                        </li>
                        <li>
