        ...
        <ul class="space-y-2 font-medium">
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Manage RM</span>
                </a>
            </li>
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Manage FG</span>
                </a>
            </li>
            <li>
                <a href="#"
            ...
            <li>
                <a href="#"
                    ...
                    <span class="flex-1 ms-3 whitespace-nowrap">Dispatch Product</span>
                </a>
            </li>
        </ul>
