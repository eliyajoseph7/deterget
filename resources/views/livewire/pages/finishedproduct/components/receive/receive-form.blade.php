<div class="bg-white rounded-lg shadow-md relative">
    <div class="pb-1"></div>
    <div class="text-center bg-red-50 rounded-xl py-5 mx-2 font-bold text-gray-600">Receive Product's Form</div>
    @if ($product_id)
    ...
    @endif
    <form wire:submit.prevent="{{ $action }}ReceiveProduct">
        <div class="p-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">

            <div class="col-span-full">
                <label for="product_id" class="block text-sm font-medium leading-6 text-gray-900">Product<span class="text-red-500">*</span></label></label>
                <div class="mt-2">
                    <div wire:ignore
            ...
            <div class="col-span-full">
                <label for="pieces" class="block text-sm font-medium leading-6 text-gray-900">Pieces per product <span
                        class="text-red-500">*</span></label>
                <div class="mt-2">
                    <div
                        class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                        <input type="number" min="1" id="pieces" wire:model.live="pieces"
                            ...
                            placeholder="Enter received pieces">
                    </div>
                    <div class="text-red-500 text-sm">
                        @error('pieces')
                            <span class="error">{{ $message }}</span>
