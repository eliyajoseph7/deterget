                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        ...
                                                        <td>
                                                            <div class="shadow-sm hover:shadow-lg bg-gray-50 px-2 w-10 rounded-lg" title="View Movement by Date">

                                                                <a href="{{ route('rm_report_by_date', [$dt->raw_material_id]) }}" class="">
