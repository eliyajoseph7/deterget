<div class="bg-white rounded-lg shadow-md relative">
    <div class="pb-1"></div>
    <div class="text-center bg-red-50 rounded-xl py-5 mx-2 font-bold text-gray-600">Confirmation Form</div>
    ...
    @endif
    <form wire:submit.prevent="confirmProductReceival">
        <div class="p-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">

            <div class="col-span-full">
                <label for="warehouse_received" class="block text-sm font-medium leading-6 text-gray-900">Product Received?<span class="text-red-500">*</span></label></label>
                <div class="mt-2">
                    <div
                        ...
                        <select type="text" id="warehouse_received" wire:model.live="warehouse_received"
            ...
            <div class="col-span-full mb-4">
                <label for="comment" class="block text-sm font-medium leading-6 text-gray-900">comment <span
                        class="text-red-500">*</span></label>
                <div class="mt-2">
                    <div
                        class="flex rounded-md shadow-sm ring-1 ring-inset ring-gray-300 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 w-full">
                        <textarea type="text" id="comment" wire:model.live="comment"
