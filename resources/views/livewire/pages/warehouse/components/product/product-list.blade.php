                                        ...
                                        <tbody
                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 whitespace-nowrap">
                                                        {{ $dt->quantity }}</td>
                                                    <td class="px-4 py-3 whitespace-nowrap hidden">
                                                        {{ $dt->warehouse_received }}</td>
                                                        <td class="px-4 py-3">
                                                            {{ $dt->comment }}</td>
                                                    <td class="px-4 py-3 flex items-center justify-end space-x-1">
                                                        <button title="Confirm"
                                                            wire:click="$dispatch('openModal', {component: 'pages.warehouse.components.product.confirm-form', arguments: {id: {{ $dt->id }}}})"
