<div class="bg-white rounded-lg shadow-md relative">
    <div class="pb-1"></div>
    <div class="text-center bg-red-50 rounded-xl py-5 mx-2 font-bold text-gray-600">Remain Product's Form</div>
    @if ($product_id)
    ...
    @endif
    <form wire:submit.prevent="{{ $action }}Remain">
        <div class="p-5 grid grid-cols-1 gap-x-6 gap-y-4 sm:grid-cols-6">

            <div class="col-span-full">
                <label for="remain_product_id" class="block text-sm font-medium leading-6 text-gray-900">Product<span class="text-red-500">*</span></label></label>
                <div class="mt-2">
                    <div wire:ignore
                        ...
                        <select type="text" id="remain_product_id"
