    ...
    <div class="min-h-[80vh] dark:bg-gray-800 overflow-hidden sm:rounded-lg items-center w-full relative">
        ...
        <div class=" border-t-2 border-gray-100 rounded-lg px-4 py-3 z-50">
            @if (Helper::has_role('import-transactions'))
                <div class="flex justify-end items-center space-x-2">
                    <div class="flex items-center justify-end d p-4 dark:bg-gray-700">
                        <button wire:click="$dispatch('openModal', { component: 'pages.reconciliation.add-transaction' })"
                            class="flex text-sm items-center text-sky-500 bg-gray-50 hover:text-sky-700 rounded-lg px-2.5">
            ...
            <div class="grid md:grid-cols-2 gap-4">
                @livewire('pages.reconciliation.components.day-sales')
                @livewire('pages.reconciliation.components.day-transactions')
            </div>
