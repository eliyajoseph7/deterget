            ...
            <div class="max-w-full mx-auto sm:px-6 lg:px-0">
                <div class="w-full">
                    <div class="flex justify-end pb-2 space-x-2">
                        <button
                            wire:click="$dispatch('openModal', {component: 'pages.rawmaterial.components.dispatch.dispatch-form'})"
                            ...
                            <span class="">{{ __('Dispatch Material') }}</span>
                        </button>
                        <a
                            href="{{ route('multiple_materials_dispatch') }}"
                            class="items-center space-x-0.5 text-gray-600 hover:text-gray-500 bg-gray-50 hover:bg-white shadow-sm hover:shadow-md px-2 border-2 border-gray-100 mt-2 py-1 rounded-lg">
                            <i class="fa-solid fa-plus-circle"></i>
                            <span class="">{{ __('Dispatch Multiple Material') }}</span>
                        </a>
                                            ...
                                            @forelse ($data as $dt)
                                                <tr wire:key="{{ $dt->id }}"
                                                    ...
                                                    <td class="px-4 py-3 flex items-center justify-end space-x-1">
                                                        <button title="Update"
                                                            wire:click="$dispatch('openModal', {component: 'pages.rawmaterial.components.dispatch.dispatch-form', arguments: {id: {{ $dt->id }}}})"
